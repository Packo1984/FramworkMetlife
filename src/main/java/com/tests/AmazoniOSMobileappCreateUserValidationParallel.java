...
import main.java.com.businessfunctions.IOSAmazonLogin;
...
public class AmazoniOSMobileappCreateUserValidationParallel {
	TestCaseDriver tcdriver;
	GenericClass coreMethods = new GenericClass("AmazoniOSMobileappCreateUserValidationParallel");
	...
	public void amazonCreateUserValidation() throws InterruptedException {
		...
		IOSAmazonLogin mobileapploginobj = PageFactory.initElements(tcdriver.getDriver(), IOSAmazonLogin.class);
		
		coreMethods.test = coreMethods.report.startTest("Test-: TC " + "AndroidAppTestScript" );
