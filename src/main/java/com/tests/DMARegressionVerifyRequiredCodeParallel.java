...
public class DMARegressionVerifyRequiredCodeParallel {
	TestCaseDriver tcdriver;
	GenericClass coreMethods = new GenericClass("DMARegressionVerifyRequiredCodeParallel");
	...
	public void verifyRequiredCode() {
		try {
			...
			String testname = "VerifyCodeList";

			Map<String, String> testData = tcdriver.readExcel(testname);

			loginobj.login(tcdriver,testData);
